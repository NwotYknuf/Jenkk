...
class BasicController extends Controller<BasicStateInfo, void>  {

    private updatedBoard: boolean = false;
    private updatedQueue: boolean = false;
    private updatedHeld: boolean = false;

    constructor(inputManager: InputManager<BasicStateInfo, void>, state: GameState, rotationSystem: RotationSystem) {
        super(inputManager, state, rotationSystem,)
    }
    ...
    private getGameInfo(): BasicStateInfo {
        return {
            board: {
    ...
    public init(): BasicStateInfo {
        this.refillQueue();
        this.spawnPiece();
        return this.getGameInfo();
    }

    public update(): BasicStateInfo {
